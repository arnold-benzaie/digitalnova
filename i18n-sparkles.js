...
const T = {
  ...
  "Votre boutique en ligne professionnelle, prête à vendre au Canada et partout dans le monde. Intégration Stripe pour paiements par carte, gestion des stocks automatisée, multi-langues et multi-devises.":"Your professional online store, ready to sell in Canada and worldwide. Stripe integration for card payments, automated inventory, multi-language and multi-currency.",
  "Jusqu'à 200 produits configurés":"Up to 200 products configured",
  "Intégration Stripe — toutes cartes":"Stripe integration — all cards",
  ...
  "Boutique en ligne conforme aux normes européennes (RGPD, TVA intracommunautaire, Directive consommateurs). Paiements Stripe, gestion multi-pays, livraison Europe automatisée.":"Online store compliant with European standards (GDPR, intra-community VAT, Consumer Directive). Stripe payments, multi-country management, automated Europe delivery.",
  "200 produits configurés":"200 products configured",
  "Stripe — toutes cartes EU acceptées":"Stripe — all EU cards accepted",
  ...
  "Mon e-commerce livré 5 jours avant le délai prévu et il dépasse toutes mes attentes. L'intégration Stripe fonctionne parfaitement, la formation était excellente. Chiffre d'affaires en ligne multiplié par 3 en 6 mois. Je recommande sans réserve !":"My e-commerce delivered 5 days early and exceeds all my expectations. Stripe integration works perfectly, training was excellent. Online revenue multiplied by 3 in 6 months. I recommend without reservation!",
  ...
  "12 certifications · 2 partenariats officiels":"12 certifications · 2 official partnerships",
  "Certifié ✓":"Certified ✓",
  "Certified ✓":"Certified ✓",
  "Individual ✓":"Individual ✓",
  ...
  "Tél : +1 (514) 800-0000":"Tel: +1 (514) 800-0000",
  ...
  "Tél : +33 1 80 00 00 00":"Tel: +33 1 80 00 00 00",
  ...
  // Footer
  "Canada Inc. — Marketing Digital International":"Canada Inc. — International Digital Marketing",
  "Agence de marketing digital certifiée Google Premier Partner, enregistrée au Canada et présente en Europe. Votre succès numérique, notre mission.":"Google Premier Partner certified digital marketing agency, registered in Canada and present in Europe. Your digital success, our mission.",
  "Canada · France · Europe":"Canada · France · Europe",
