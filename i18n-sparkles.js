...
const T = {
  ...
  "Avant tout paiement, vous recevez un devis détaillé : service choisi, livrables, délai, prix et prochaines étapes. Le paiement n'est envoyé qu'après validation, via Lemon Squeezy, pour garder un processus professionnel et traçable.":"Before any payment, you receive a detailed quote: selected service, deliverables, timeline, price, and next steps. Payment is sent only after approval, via Lemon Squeezy, to keep the process professional and traceable.",
  ...
  "Lien Lemon Squeezy sécurisé":"Secure Lemon Squeezy link",
  "Cartes internationales":"International cards",
  "Méthodes disponibles selon le pays, l'appareil et l'activation du compte.":"Methods available depending on country, device, and account activation.",
