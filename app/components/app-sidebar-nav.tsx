...
type NavDict = {
  ...
  items: {
    ...
    auditLog: string; systemHealth: string; siteAnalytics: string; crmDashboard: string; clients: string; radar: string; pipeline: string; contracts: string; quotes: string;
