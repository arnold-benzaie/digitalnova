...
test("integration: preflight report over all 15 real db/migrations files matches the Phase 3 dry-run plan exactly", async () => {
  ...
  assert.equal(report.statementCount, 215);
  assert.equal(report.migrationFiles.length, 15);
