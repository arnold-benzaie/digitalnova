...
test("integration: preflight report over all 23 real db/migrations files matches the Phase 3 dry-run plan exactly", async () => {
  ...
  assert.equal(report.statementCount, 249);
  assert.equal(report.migrationFiles.length, 23);
