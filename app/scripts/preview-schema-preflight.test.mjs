...
test("integration: preflight report over all 21 real db/migrations files matches the Phase 3 dry-run plan exactly", async () => {
  ...
  assert.equal(report.statementCount, 227);
  assert.equal(report.migrationFiles.length, 21);
