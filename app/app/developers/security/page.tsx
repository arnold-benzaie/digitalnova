  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-6 px-6 py-12">
      ...
      <Section title={t.sections.keys.title}>
        <p className="text-muted-foreground">{t.sections.keys.body}</p>
      </Section>
      ...
      <Section title={t.sections.transport.title}>
        <p className="text-muted-foreground">{t.sections.transport.body}</p>
      </Section>
      <Section title={t.sections.limits.title}>
        <p className="text-muted-foreground">{t.sections.limits.body}</p>
      </Section>
      <Section title={t.sections.disclosure.title}>
        <p className="text-muted-foreground">{t.sections.disclosure.body}</p>
      </Section>
    </div>
  );
}
