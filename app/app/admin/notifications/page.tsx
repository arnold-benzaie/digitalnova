...
export default async function AdminNotificationsPage() {
  ...
  return (
    <>
      <h1 className="font-serif text-3xl font-semibold text-pm-noir">Notifications — {org.name}</h1>
      <p className="mt-2 text-sm text-pm-gris">Historique complet des notifications de cette organisation.</p>
