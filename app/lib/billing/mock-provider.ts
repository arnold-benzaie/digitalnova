...
const PLANS: Plan[] = [
  { id: "starter", name: "Starter", priceEuros: 49, billingInterval: "monthly", description: "1 établissement, audit mensuel." },
  { id: "pro", name: "Pro", priceEuros: 149, billingInterval: "monthly", description: "Jusqu'à 5 établissements, audits illimités, rapports automatiques." },
  { id: "agency", name: "Agence", priceEuros: 399, billingInterval: "monthly", description: "Établissements illimités, accès CRM complet, support prioritaire." },
];
