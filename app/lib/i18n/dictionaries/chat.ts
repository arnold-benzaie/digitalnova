...
export const chat = {
  fr: {
    ...
    leadForm: {
      ...
      phoneCountryAriaLabel: "Indicatif du pays",
      phoneCountrySearchPlaceholder: "Rechercher un pays, indicatif ou code…",
      phoneInvalidError: "Ce numéro de téléphone ne semble pas valide.",
      company: "Entreprise",
      country: "Pays",
      ...
      preferredDate: "Date souhaitée (facultatif)",
      preferredTime: "Créneau / heure souhaitée (facultatif)",
      preferredNote: "Préférence indicative — pas une réservation confirmée tant qu'un conseiller ne vous a pas recontacté.",
  ...
  en: {
    ...
    leadForm: {
      ...
      phoneCountryAriaLabel: "Country calling code",
      phoneCountrySearchPlaceholder: "Search a country, code or dial code…",
      phoneInvalidError: "This phone number doesn't look valid.",
      company: "Company",
      country: "Country",
      ...
      preferredNote: "Indicative preference — not a confirmed booking until an advisor has followed up with you.",
