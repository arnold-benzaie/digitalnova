...
const isPublicRoute = createRouteMatcher([
  ...
  // TEMPORARY — Preview-only schema diagnostic, own VERCEL_ENV guard +
  // header-secret check (see the route file). To be removed in the very
  // next commit on this branch once used.
  "/api/market-schema-check",
